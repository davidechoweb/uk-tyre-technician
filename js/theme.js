  ...
  */
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    Element.prototype.isInViewport = function (offset) {
      ...
      var elementTop = this.getBoundingClientRect().top + offset;
    ...
    var elementEntranceFade = function elementEntranceFade() {
      console.log('Running');
      document.querySelectorAll(".ews-animate").forEach(function (element) {
        if (element.isInViewport()) {
          var delay = element.getAttribute("data-ews-delay") || 0;
          var anim = element.getAttribute("data-ews-animate") || "ani-fade";
          setTimeout(function () {
